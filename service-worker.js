...
const CACHE_NAME = 'thumbnail-memo-v87-inline-btns';
const urlsToCache = [
  '/my-memo-app/',
...
self.addEventListener('install', event => {
  console.log('🔧 Service Worker v87 설치 중...');
  event.waitUntil(
    caches.open(CACHE_NAME)
      ...
      .then(() => {
        console.log('✅ Service Worker v87 설치 완료, 즉시 활성화');
...
self.addEventListener('activate', event => {
  console.log('🚀 Service Worker v87 활성화 중...');
  event.waitUntil(
    caches.keys().then(cacheNames => {
      ...
      console.log('✅ Service Worker v87 완전 활성화, 모든 탭 제어');
